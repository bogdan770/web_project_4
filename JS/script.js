...
console.log(userName.textContent, userProf.textContent);
//checking that strings contain correct "parameter"
...
// checking what JS in this values

editButton.addEventListener('click', () =>{ 
    nameInput.value = userName.textContent; 
    jobInput.value = userProf.textContent; 
    displayPopup.classList.add("popup__display");
...
function closePopup(){
    displayPopup.classList.remove("popup__display");
}
